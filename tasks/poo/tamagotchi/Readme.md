...
![cover](../../.tko/cache/poo/base/tamagotchi/cover.jpg)
...
![diagrama](../../.tko/cache/poo/base/tamagotchi/diagrama.png)

[![youtube icon](../../.tko/cache/poo/base/tamagotchi/../youguide.png)](https://youtu.be/VRW3_JuNwkA?si=827by8nZURcc2AuM)
...
<!-- links .cache/draft -->
- cpp
  - [shell.cpp](../../.tko/cache/poo/base/tamagotchi/.cache/draft/cpp/shell.cpp)
- java
  - [Shell.java](../../.tko/cache/poo/base/tamagotchi/.cache/draft/java/Shell.java)
- ts
  - [shell.ts](../../.tko/cache/poo/base/tamagotchi/.cache/draft/ts/shell.ts)
<!-- links -->
